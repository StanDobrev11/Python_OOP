"""
Create class Employee. Upon initialization, it should receive id (number), first_name (string), last_name
(string), and salary (number). Create 3 additional instance methods:
