...
given amount and return a message "{name} watched {course_name}".
...
knows {language}".
o In the last case, the programmer does not have enough skills, so return "{name} needs
...
print(programmer.watch_course("Java: zero to TE_03_Hero", "Java", 50))
print(programmer.change_language("Python", 100))
print(programmer.watch_course("Python Masterclass", "Python", 84))
